        ...
        <section className=" px-150 bg-gray-100 min-h-screen flex items-center justify-center w-full ">
            <div className=" w-100 mx-auto mt-20 p-6 bg-blue-950  rounded-lg shadow-md ">
                <form onSubmit={handleSignup}>
                    ...
                    <button type="submit" className="mt-4 p-3 w-full bg-orange-500 hover:bg-orange-700 cursor-pointer text-violet-500 rounded-md">Sign  Up</button>
                </form>
                <p className="text-center text-violet-500 mt-4">Already have an account? <Link to="/login" className="text-orange-500 hover:underline">Log in</Link></p>
            </div>
        </section>
